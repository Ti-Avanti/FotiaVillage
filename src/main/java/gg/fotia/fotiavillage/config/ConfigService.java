    ...
    private FotiaSettings read(FileConfiguration config) {
        return new FotiaSettings(
            ...
            new FotiaSettings.Lifespan(
                ...
                atLeast(config.getInt("villager-lifespan.display.visibility.low-lifespan-always-show-seconds", 3600), 0),
                config.getBoolean("villager-lifespan.display.decent-holograms.enabled", false),
